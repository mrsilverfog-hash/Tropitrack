...
public class FrenchNames {
    ...
    static {
        ...
        NAMES.put("ceruledge", "Céruledge"); NAMES.put("cetitan", "Balbalèze"); NAMES.put("cetoddle", "Piétacé");
        ...
        NAMES.put("clawitzer", "Clawitzer"); NAMES.put("claydol", "Kaorine"); NAMES.put("clefable", "Mélodelfe");
        ...
        NAMES.put("cottonee", "Doudouvet"); NAMES.put("crabominable", "Crabominable"); NAMES.put("crabrawler", "Crabrawler");
        ...
        NAMES.put("croconaw", "Crocrodil"); NAMES.put("crustle", "Crabaraque"); NAMES.put("cryogonal", "Ségelente");
        ...
        NAMES.put("dewott", "Mateloutre"); NAMES.put("dhelmise", "Démoliosse"); NAMES.put("dialga", "Dialga");
        ...
        NAMES.put("dracozolt", "Dracozolt"); NAMES.put("dragalge", "Phanceros"); NAMES.put("dragapult", "Lanssorien");
        NAMES.put("dragonair", "Draco"); NAMES.put("dragonite", "Dracolosse"); NAMES.put("drakloak", "Dispareptil");
        NAMES.put("drapion", "Drapion"); NAMES.put("dratini", "Minidraco"); NAMES.put("drednaw", "Torgamord");
        ...
        NAMES.put("flamigo", "Flamigo"); NAMES.put("flapple", "Croquitimon"); NAMES.put("fletchinder", "Braisillon");
        ...
        NAMES.put("gurdurr", "Ouvrifier"); NAMES.put("gyarados", "Léviator"); NAMES.put("happiny", "Toudoudou");
        NAMES.put("hariyama", "Hariyama"); NAMES.put("hatenna", "Bibichut"); NAMES.put("hatterene", "Sorcilence");
        NAMES.put("hattrem", "Chapotus"); NAMES.put("haunter", "Spectrum"); NAMES.put("hawlucha", "Brutalibre");
        NAMES.put("haxorus", "Tranchodon"); NAMES.put("heatmor", "Ohmassacre"); NAMES.put("heatran", "Heatran");
        NAMES.put("helioptile", "Galvaran"); NAMES.put("heliolisk", "Héliocifer"); NAMES.put("heracross", "Scarhino");
        ...
        NAMES.put("pawniard", "Scalpion"); NAMES.put("pecharunt", "Pecharunt"); NAMES.put("pelipper", "Bekipan");
        ...
        NAMES.put("piloswine", "Cochignon"); NAMES.put("pincurchin", "Ourswine"); NAMES.put("pinsir", "Scarabrute");
        NAMES.put("piplup", "Tiplouf"); NAMES.put("plusle", "Plusle"); NAMES.put("poipole", "Vémini");
        ...
        NAMES.put("roggenrola", "Nodulithe"); NAMES.put("rookidee", "Miniorat"); NAMES.put("roselia", "Rosélia");
        ...
        NAMES.put("scrafty", "Baggaïd"); NAMES.put("scraggy", "Baggiguane"); NAMES.put("scream_tail", "Queue-de-Cri");
        ...
        NAMES.put("sunflora", "Hélianthus"); NAMES.put("sunkern", "Tournegrin"); NAMES.put("surskit", "Arakdo");
        ...
        NAMES.put("tsareena", "Tsareena"); NAMES.put("turtwig", "Tortipouss"); NAMES.put("tympole", "Tritonde");
        ...
        NAMES.put("zebstrika", "Zéblitz"); NAMES.put("zekrom", "Zekrom"); NAMES.put("zeraora", "Zéraora");
